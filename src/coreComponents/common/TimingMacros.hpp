...
#define GEOSX_CALIPER_MARK_SCOPE(name) cali::Function GEOSX_CONCAT(_cali_ann, __LINE__)(STRINGIZE_NX(name))

/// Mark a function for timing using a compiler-provided name
#define GEOSX_CALIPER_MARK_FUNCTION cali::Function _cali_ann_func(timingHelpers::stripPF(__PRETTY_FUNCTION__).c_str())
